          ...
          <div class="body-wrap">
            ...
            <div class="dialog-buttons" v-show="buttons.length>0&&note">
              <div style="margin-left: 30px" class="fl" v-show="note">
                <div class="dialog-radio cursor-pointer" :class="isSelectRadio?'select-radio':''"
