<template>
  <div style="width: 100%;height: 100%">
    <div class="table">
      <div class="table-header back-f8f9fa" :style="{minWidth: minWid}">
          ...
          <div v-for="(data,ind) in datas" class="table-row body-row c3 fs12 border-bott"
            ...
            <div v-for="(titl,index) in titleData" :class="[index==(titleData.length-1)?'':'boder-rig']"
              ...
              <span v-if="titl.type=='button'">
                <span v-for="btn in titl.operations" class="pl10 cursor-pointer color-1188dd fs16" :title="btn.text"
              ...
              <!--              多选框-->
              <div v-if="chooseWay=='checkbox'" class="table-checkbox"
